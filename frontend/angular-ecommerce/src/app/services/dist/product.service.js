...
var ProductService = /** @class */ (function () {
    function ProductService(httClient) {
        this.httClient = httClient;
        this.baseUrl = "http://localhost:8080/api/products"; //Spring Boot backend API
    }
    ...
    ProductService.prototype.getProductList = function () {
        return this.httClient
            .get(this.baseUrl)
            .pipe(operators_1.map(function (response) { return response._embedded.products; }));
    };
